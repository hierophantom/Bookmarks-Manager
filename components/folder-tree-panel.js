 ...
 *
 * @example
 * const folderView = createFolderTreePanel({
 *   docked: false,
 ...
 */
function createFolderTreePanel(options = {}) {
  const {
    docked = false,
    onClose = null,
    onToggleMode = null,
  ...
  panel.element.classList.add('folder-tree-panel');
  panel.content.classList.add('folder-tree-panel__content');
